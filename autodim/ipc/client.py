# autodim/ipc/client.py
# Autodim IPC client — used by the web process.
# Mirrors pci/rtig/ipc/client.py exactly — singleton, fixed socket paths.
...
log = logging.getLogger('pci.autodim.ipc.client')
...
class AutodimClient:
    ...
    def _connect_and_read(self):
        ...
        self.connected = True
        log.info("connected to autodim live push socket")
