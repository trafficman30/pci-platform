# offline/ipc/client.py
# Offline plan IPC client — used by the web process.
# Mirrors pci/rtig/ipc/client.py — singleton, fixed socket paths.
...
log = logging.getLogger('pci.offline.ipc.client')
...
class OfflineClient:
    ...
    def _connect_and_read(self):
        ...
        self.connected = True
        log.info("connected to offline live push socket")
